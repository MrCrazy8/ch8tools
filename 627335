...
[5] Download web tools

[6] Download hack tools

[7] Make A Password

[8] Download Kali linux bash for termux
...
if input1 == "4":
  ...
  myin = raw_input(color.red + "Enter The website addr > ")
...
[4] bypass clud flare with protocol

[5] sqlmap

'''
  lin = raw_input("Enter The Number > ")
# -------------------------------------
  if lin == "1" :
...
if input1 == "7":
  ...
  st = pin[::-1]
  print "     "
  print color.blue + "YOUR PASSWORD : " + color.red + str(ra) + pin +"8ao$"+ str(rs) + st
...
if input1 == "8":
  ...
  os.system("hash -r")
  os.system("wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resource/master/Scripts/Installer/Kali/kali.sh")
...
if input1 == "9":
  ...
  inputln = raw_input(color.yellow + "Enter The Url > ")
  openln = requests.get(inputln , timeout=10)
  var1 = str(openln.cookies)
  var2 = openln.status_code
  var3 = openln.headers
  var4 = openln.url
  var5 = openln.text
  var6 = openln.content
